...
--}}
                    ...
                    <form action="{{ route('posts.destroy', $post) }}" method="POST">
                        ...
                        <input type="submit" value="Eliminar publicación"
                            class="bg-red-500 hover:bg-red-600 transition-colors cursor-pointer
                                    uppercase font-bold p-2 text-white rounded-lg mt-5" />
                    </form>
                @endif
            @endauth
        </div>
        <div class="md:w-1/2 p-5">
            <div class="shadow bg-white mb-5 p-5">
                ...
                @auth()
                    <p class="text-xl font-bold text-center mb-4">Añade un nuevo comentario</p>

                    @if (session('mensaje'))
                        <div class="bg-green-500 p-2 rounded-lg mn-6 text-white text-center uppercase font-bold">
                            {{ session('mensaje') }}
                        </div>
                    @endif
